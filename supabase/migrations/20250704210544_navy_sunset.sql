/*
  # Sistema completo de usuarios con Supabase Auth

  1. Estructura de Base de Datos
    - Recrear enum user_role con todos los roles
    - Crear tabla user_profiles completa
    - Crear tabla clients separada
    - Configurar todas las políticas RLS
...
-- 4. POLÍTICAS DE SEGURIDAD PARA USER_PROFILES
...
-- 9. HABILITAR RLS PARA CLIENTES
ALTER TABLE clients ENABLE ROW LEVEL SECURITY;

-- 10. POLÍTICAS PARA CLIENTES
...
-- 11. ACTUALIZAR POLÍTICAS DE PROPIEDADES
...
-- 12. ACTUALIZAR POLÍTICAS DE TASACIONES
...
-- 13. ACTUALIZAR POLÍTICAS DE VISITAS
...
-- 14. FUNCIÓN DE AUDITORÍA MEJORADA
...
-- 15. TRIGGERS DE AUDITORÍA PARA CLIENTES
...
-- 16. INSERTAR DATOS DE EJEMPLO PARA CLIENTES
...
-- 17. CREAR USUARIOS EN AUTH.USERS
DO $$
DECLARE
